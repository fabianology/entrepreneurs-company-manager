...
const DocumentList: React.FC<DocumentListProps> = ({ 
  ...
  return (
    <div className="space-y-5 animate-fadeIn">
      ...
      <div className="w-full h-10 bg-stone-900/60 backdrop-blur-xl rounded-full border border-white/10 shadow-2xl flex items-center justify-center p-1 overflow-hidden ring-1 ring-black/5 mb-2">
        <button
          onClick={handleAddNew}
          className="h-full px-8 text-white rounded-full text-[13px] font-bold uppercase tracking-[0.2em] hover:bg-white/5 active:bg-white/10 transition-all flex items-center space-x-2 active:scale-95 group"
        >
