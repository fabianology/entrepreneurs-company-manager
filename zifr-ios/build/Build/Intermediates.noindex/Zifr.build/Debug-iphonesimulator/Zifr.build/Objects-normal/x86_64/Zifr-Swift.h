...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Zifr",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Zifr13AuthViewModel")
@interface AuthViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASAuthorizationController;
@interface AuthViewModel (SWIFT_EXTENSION(Zifr)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface AuthViewModel (SWIFT_EXTENSION(Zifr)) <ASAuthorizationControllerDelegate>
