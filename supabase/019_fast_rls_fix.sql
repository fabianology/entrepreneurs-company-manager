-- ========================================================================================
-- 019_fast_rls_fix.sql
-- Run this in Supabase SQL Editor. 
-- Fixes statement timeout by replacing correlated EXISTS subqueries with 
-- non-correlated IN clauses. This guarantees the subquery is evaluated only once 
-- instead of for every row, completely eliminating the timeout loop.
-- ========================================================================================
...
-- 2. Drop all previous functions and policies
DROP FUNCTION IF EXISTS public.has_company_access(UUID);
DROP FUNCTION IF EXISTS public.has_company_write_access(UUID);
